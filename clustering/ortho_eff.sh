...
cd /storage/home/users/pjt6/phy//effectors
rm *fasta_*
...
grep "Probability: o3=" -H *_stats.txt > /storage/home/users/pjt6/phy/ORTHOFINDER_effector_no_gaps__orthofinder_DN_DS.txt
