cd /storage/home/users/pjt6/phy
...
cd /storage/home/users/pjt6/phy/RBBH


# cat ../*.tab | cut -f1,2,10 | grep -v "#" >all_vs_all.abc
...
cd /storage/home/users/pjt6/phy/RBBH//effectors
rm *fasta_*
...
python /storage/home/users/pjt6/phy/Align_back_translate.py
...
grep "Probability: o3=" -H *_stats.txt > /storage/home/users/pjt6/phy/RBBH/effector_no_gaps_RBBH_orthofinder_DN_DS.txt



cd /storage/home/users/pjt6/phy/RBBH//busco/
rm *fasta_*
rm -rf back_translated
filenames=*.fasta
...
grep "Probability: o3=" -H *_stats.txt > /storage/home/users/pjt6/phy/RBBH/busco_no_gaps_RBBH_orthofinder_DN_DS.txt



cd /storage/home/users/pjt6/phy/RBBH//sub
rm *fasta_*
rm -rf back_translated
...
cd /storage/home/users/pjt6/phy/RBBH//gros/
rm *fasta_*
rm -rf back_translated
filenames=*.fasta
