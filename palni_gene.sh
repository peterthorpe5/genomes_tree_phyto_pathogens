...
nem_dir=/storage/home/users/pjt6/docker/singulairty/funannotate/palni/Phyalni//annotate_results/

known_fa="${nem_dir}/Gpal_aa_fromNCBI_JJ.fasta"
known_fa_nucl="Gpal_newtontest03_newton.transcripts.fa"
prefix="PHYALNI"
test_fa="ppsue.v1_ppsue.proteins.fa"
test_fa_nt="Gpal_newtontest03_newton.transcripts.fa"
cp ${test_fa} aa.fa
min_len_gene="5"
threads=8
python_directory=$HOME/public_scripts/gene_model_testing/
Working_directory=/storage/home/users/pjt6/docker/singulairty/funannotate/palni/Phyalni/annotate_results/
test_gff="${nem_dir}/ppsue.v1_ppsue.gff3"

genome="/storage/home/users/pjt6/docker/singulairty/funannotate/palni/Phyalni/annotate_results//ppsue.v1_ppsue.scaffolds.fa"
