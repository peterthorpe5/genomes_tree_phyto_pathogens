...
#make_repeatmodeler_database(name='a_database',
                            #input_filename='Palni.v1.genome.fasta')
...
TEs_from_OCFA, serial = parse_ocfa_elem_stored('/home/pt40963/scratch/phy_genomes/palni/Palni.v1.genome.fasta.preFriSep291756332017.RMoutput/')
#
...
TEs, serial = integrate_ltrharvest_to_RM_TEs('/home/pt40963/scratch/phy_genomes/palni/Palni_LTR_harvest.out',      
                                              '/home/pt40963/scratch/phy_genomes/palni/Palni.v1.genome.fasta',  
                                              TEs_from_OCFA,
                                             serial)
...
#                                                                        
# \# adding TransposonPSI results to the data structure          dth                                                       
TEs = integrate_TransposonPSI_to_RM_TEs('/home/pt40963/scratch/phy_genomes/palni/Palni.v1.genome.fasta.TPSI.allHits.chains.bestPerLocus', 
                                         '/home/pt40963/scratch/phy_genomes/palni/Palni.v1.genome.fasta', 
                                         TEs, 
                                         serial)
