...
#make_repeatmodeler_database(name='a_database',
                            #input_filename='P.seudo.v1.genome.fasta')
...
TEs_from_OCFA, serial = parse_ocfa_elem_stored('/home/pt40963/scratch/phy_genomes/ppseu/P.seudo.v1.genome.fasta.preMonOct161353092017.RMoutput/')
#
...
TEs, serial = integrate_ltrharvest_to_RM_TEs('/home/pt40963/scratch/phy_genomes/ppseu/Psue_LTR_harvest.out',      
                                              '/home/pt40963/scratch/phy_genomes/ppseu/P.seudo.v1.genome.fasta',  
                                              TEs_from_OCFA,
                                             serial)
...
TEs = integrate_TransposonPSI_to_RM_TEs('/home/pt40963/scratch/phy_genomes/ppseu/P.seudo.v1.genome.fasta.TPSI.allHits.chains.bestPerLocus', 
                                         '/home/pt40963/scratch/phy_genomes/ppseu/P.seudo.v1.genome.fasta', 
                                         TEs, 
                                         serial)
...
write_gff(TEs, 'P.seudo.v1.transposable_elements.gff3', max_RM_OC_score=False)
