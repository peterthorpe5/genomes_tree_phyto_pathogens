...
genome_test="P.seudo.v1.genome.fasta.masked"
prefix="PHSU"
# default name
test_fa="aa.fa"
min_len_gene="20"
...
Working_directory=/home/pt40963/scratch/phy_genomes/ppseu/ppsue_masked_${Aug_species}_${genome_test}
test_gff="${Working_directory}/Ppseu_${Aug_species}.gff"
# for the repeat masking and GFF I used a altered gene name version
genome="/home/pt40963/scratch/phy_genomes/ppseu/P.seudo.v1.genome.fasta.masked"
