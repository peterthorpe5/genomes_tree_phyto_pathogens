...
/mnt/apps/clcBio/clc-assembly-cell-4.1.0-linux_64/clc_assembler --cpus 10 -m 240 -w 64 -b 77 -v -o /home/pt40963/scratch/phy_genomes/ppseu/clc.all.v3.fa -p fb ss 200 800 -q -i bait_match_bait_match_R1.fastq bait_match_bait_match_R2.fastq
...
/mnt/apps/clcBio/clc-assembly-cell-4.1.0-linux_64/clc_mapper -d /home/pt40963/scratch/phy_genomes/ppseu/clc.all.v3.fa -o contig.mappingall3.cas -p fb ss 200 800 -q -i bait_match_bait_match_R1.fastq bait_match_bait_match_R2.fastq --cpus 10 -r unpairedclosest
...
python ~/Downloads/blobtools-light-master/mapping2cov.py -a /home/pt40963/scratch/phy_genomes/ppseu/clc.all.v3.fa -cas /home/pt40963/scratch/phy_genomes/ppseu/contig.mappingall3.cas -o contig.mappingall3.cas.cov
