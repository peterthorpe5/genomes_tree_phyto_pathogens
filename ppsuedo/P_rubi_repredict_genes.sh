...
# run star first
/home/pt40963/scratch/p_rubi/shell_scripts/P_rubi_star.sh
...
Working_directory=/home/pt40963/scratch/p_rubi/genome/P_rubi_${Aug_species}_repeat
test_gff="${Working_directory}/${Aug_species}.gff"
# for the repeat masking and GFF I used a altered gene name version
genome="/home/pt40963/scratch/p_rubi/genome/prubii_q20l50_w23.fasta"
...
left_reads="/home/pt40963/scratch/p_rubi/RNAseq/R1.fq.gz"
right_reads="/home/pt40963/scratch/p_rubi/RNAseq/R2.fq.gz"
...
aug="$HOME/scratch/Downloads/augustus-3.2.1/bin/augustus 
	...
	--hintsfile=/home/pt40963/scratch/p_rubi/genome/hints_RNAseq.gff 
	--outfile=${test_gff} 
	--noInFrameStop=true 
	--species=${Aug_species}
	${genome}"
