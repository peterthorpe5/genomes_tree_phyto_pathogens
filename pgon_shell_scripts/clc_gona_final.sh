...
#/mnt/apps/clcBio/clc-assembly-cell-4.1.0-linux_64/clc_assembler --cpus 8 -m 240 -w 64 -b 77 -v -o /home/pt40963/scratch/phy_genomes/pgona/clc.all.v5.fa -p fb ss 200 800 -q -i bait_match_bait_match_bait_match_bait_match_R1.fastq bait_match_bait_match_bait_match_bait_match_R2.fastq
...
#/mnt/apps/clcBio/clc-assembly-cell-4.1.0-linux_64/clc_mapper -d /home/pt40963/scratch/phy_genomes/pgona/clc.all.v5.fa -o contig.mappingall5.cas -p fb ss 200 800 -q -i bait_match_bait_match_bait_match_bait_match_R1.fastq bait_match_bait_match_bait_match_bait_match_R2.fastq --cpus 8 -r unpairedclosest
...
#python ~/Downloads/blobtools-light-master/mapping2cov.py -a /home/pt40963/scratch/phy_genomes/pgona/clc.all.v5.fa -cas /home/pt40963/scratch/phy_genomes/pgona/contig.mappingall5.cas -o contig.mappingall5.cas.cov

wait
#######################################
#export BLASTDB=/mnt/scratch/local/blast/ncbi/
#
#blastn -task megablast -query clc.all.v5.fa -db nt -outfmt '6 qseqid staxids bitscore std scomnames sscinames sblastnames sskingdoms stitle' -evalue 1e-20 -out n.clc.all5.out -num_threads 12
#
