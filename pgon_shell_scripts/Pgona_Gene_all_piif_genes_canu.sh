...
Working_directory=/home/pt40963/scratch/phy_genomes/pgona/Pgonap_${Aug_species}_${genome_test}
test_gff="${Working_directory}/pgona_${Aug_species}.gff"
# for the repeat masking and GFF I used a altered gene name version
genome_test="P.gon.genome.v1.fasta"
genome="/home/pt40963/scratch/phy_genomes/pgona/P.gon.genome.v1.fasta"
