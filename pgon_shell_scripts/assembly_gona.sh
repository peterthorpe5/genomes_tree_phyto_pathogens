...
/mnt/apps/discovar/discovar_denovo/150826/bin/DiscovarDeNovo NUM_THREADS=24 READS=/home/pt40963/scratch/phy_genomes/pgona/reads.bam OUT_DIR=/home/pt40963/scratch/phy_genomes/pgona/pgona_discovar/


export BLASTDB=/mnt/scratch/local/blast/ncbi/

fasta=/home/pt40963/scratch/phy_genomes/pgona/pgona_discovar/a.final/a.lines.fasta

cd /home/pt40963/scratch/phy_genomes/pgona/pgona_discovar/a.final/

perl ~/misc_python/perl_misc/scaffold_stats.pl -f a.lines.fasta -k -o a.lines.fasta.stats > a.lines.fasta.out.txt

blastn -task megablast -query a.lines.fasta -db nt -outfmt '6 qseqid staxids bitscore std scomnames sscinames sblastnames sskingdoms stitle' -evalue 1e-20 -out n.palni.vs.nt.1e25.out -num_threads 24
#
##mc blast
#
#
...
#
  ...
  ~/scratch/Downloads/blobtools-master/blobtools create -i clc.all.fa  -c contig.mappingall.cas.cov -t n.clc.lanall2.out -o clc.all.fa.blobplots
